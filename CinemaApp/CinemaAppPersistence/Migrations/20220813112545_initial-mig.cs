        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosterImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TimeOfBuying = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 8, 13, 13, 25, 45, 17, DateTimeKind.Local).AddTicks(4927)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfRows = table.Column<int>(type: "int", nullable: false),
                    NumOfColumns = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieScreening", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieScreening_Movie_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movie",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seat_MovieScreening_MovieScreeningId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seat_Row_Column_MovieScreeningId",
                table: "Seat",
                columns: new[] { "Row", "Column", "MovieScreeningId" },
                unique: true);
        }
